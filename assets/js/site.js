...
SITE.badges = [
  ...
  { id:'metasploit', featured:true,  tier:'t-common',   cls2:'',     name:'Metasploitable', img:'assets/badges/thm/metasploitable.webp', tag:'common: 12.2%',      desc:'Contains the knowledge to use Metasploit',                   slug:'metasploitable', aria:'Metasploitable badge on TryHackMe' },
  { id:'blue',       featured:true,  tier:'t-common',   cls2:'',     name:'Blue', img:'assets/badges/thm/blue.webp', tag:'common: 12.8%',                          desc:'Hacking into Windows via EternalBlue',                  slug:'blue', aria:'Blue badge on TryHackMe' },
